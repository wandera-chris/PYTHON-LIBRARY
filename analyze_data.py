analyze_data.pyimport pandas as pd
...
if __name__ == "__main__":
    ...
    if cleaned_df is not None:
        print("\nDataset loaded, explored, and cleaned successfully.")

    # To run with a specific CSV file, for example, 'my_data.csv':
    # cleaned_df_custom = load_and_explore_dataset(csv_file="my_data.csv")
    # if cleaned_df_custom is not None:
    #     print("\nCustom dataset loaded, explored, and cleaned successfully.")